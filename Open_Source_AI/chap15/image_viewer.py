...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(766, 700)  # Increase the height to accommodate the result_label
        ...
        # Create a QLabel for displaying result_text
        self.result_label = QtWidgets.QLabel(Dialog)
        self.result_label.setGeometry(QtCore.QRect(30, 570, 761, 100))  # Adjust the y-coordinate
